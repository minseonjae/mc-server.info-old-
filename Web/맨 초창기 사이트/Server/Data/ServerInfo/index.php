...
<?php
	if (!empty($_GET['name'])) {
		...
		if (!file_exists("../List/".$name.".json")) {
			...
			$json_i = json_decode(file_get_contents("../List/".$name.".json"));
			echo '
				<div class="card">
					<div class="card-body">
				...
				<div class="card">
					<img class="card-img-top" src="../Banner/'.$name.'.png?v='.Date("Y.m.d.G.i").'">
					<div class="card-body">
						<div class="input-group">
							<input type="text" class="form-control" value=\'<img src="http://xn--hk3b2h33ib2i.xn--3e0b707e/Banner/'.$name.'.png">\'">
...
<?php
	if (!empty($_GET['name']) && file_exists("../List/".$name.".json")) {
		$json_m = json_decode(file_get_contents("../Max/".$name.".json"));
		echo '
...
<?php
	if (!empty($_GET['name']) && file_exists("../List/".$name.".json")) {
		$json_c = json_decode(file_get_contents("../Chart/".$name.".json"));
		$msg_p1 = "";
		$boo_p1 = false;
