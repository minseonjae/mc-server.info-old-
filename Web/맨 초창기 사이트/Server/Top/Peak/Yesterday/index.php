<?php
	...
	$top_list = getJSON("../../../../API/YesterdayPlayersTop.json")->top;
							...
							<a href="../../../../Server/?name='.$top_list[$i].'" class="list-group-item">
								...
								<div class="row">
									...
									<div class="col-xs-5 col-md-6">
										<p class="text-right">
											<span class="badge badge-success" data-toggle="tooltip" data-placement="top" title="어제 최고 동시 접속자<br>'.$data_json->peak->yesterday->time.'" data-html="true">'.$data_json->peak->yesterday->players.'명</span>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="list-group">
								<div class="list-group-item">어제 최고 동시 접속자 순위</div>
								<?php echo $message; ?>
							</div>
						</div>
					</div>
