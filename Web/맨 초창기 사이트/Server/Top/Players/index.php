<?php
	...
	$top_list = getJSON("../../../API/PlayersTop.json")->top;
							...
							<li class="list-group-item">
								<center>
									<div class="btn-group" role="group">
										<button type="button" class="btn btn-default '.($page == 1 ? 'disabled' : '').'" onClick="location.href=\'../Players/?page=1\'">맨 앞</button>';
		if ($page - 1 > 0) $message = $message.'<button type="button" class="btn btn-info" onClick="location.href=\'../Players/?page='.($page - 1).'\'"><</button>';
		for (; $i <= $m; $i++) {
			$message = $message.'
										<button type="button" class="btn btn-default '.($page == $i ? 'disabled' : '').'" onClick="location.href=\'../Players/?page='.$i.'\'">'.$i.'</button>
								';
		}
		if ($page + 1 < $top_page) $message = $message.'<button type="button" class="btn btn-info" onClick="location.href=\'../Players/?page='.($page + 1).'\'">></button>';
		$message = $message.'
										<button type="button" class="btn btn-default '.($page == $top_page ? 'disabled' : '').'" onClick="location.href=\'../Players/?page='.$top_page.'\'">맨 뒤</button>
									</div>
								</center>
							</li>
							';
							...
							<ul class="nav navbar-nav">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu" role="menu">
										...
										<li><a href="../Peak/Allday">최고 동시 접속자 순위</a></li>
										<li><a href="../Peak/Today">오늘 최고 동시 접속자 순위</a></li>
										<li><a href="../Peak/Yesterday">어제 최고 동시 접속자 순위</a></li>
									</ul>
								</li>
								<li class="dropdown">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="list-group">
								<div class="list-group-item">동시 접속자 순위</div>
								<?php echo $message; ?>
							</div>
						</div>
					</div>
