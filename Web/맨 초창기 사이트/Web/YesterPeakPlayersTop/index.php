<?php
	...
	$top_list = getJSON("../API/Peak/YesterTop.json")->list;
							...
							<li class="list-group-item">
								<center>
									<div class="btn-group" role="group">
										<button type="button" class="btn btn-'.($page == 1 ? 'secondary' : 'success').'" onClick="location.href=\'../YesterPeakPlayersTop/?page=1\'">맨 앞</button>';
		if ($page - 1 > 0) $message = $message.'<button type="button" class="btn btn-info" onClick="location.href=\'../YesterPeakPlayersTop/?page='.($page - 1).'\'"><</button>';
		for (; $i <= $m; $i++) {
			$message = $message.'
										<button type="button" class="btn btn-'.($page == $i ? 'outline-' : '').'primary" onClick="location.href=\'../YesterPeakPlayersTop/?page='.$i.'\'">'.$i.'</button>
								';
		}
		if ($page + 1 < $top_page) $message = $message.'<button type="button" class="btn btn-info" onClick="location.href=\'../YesterPeakPlayersTop/?page='.($page + 1).'\'">></button>';
		$message = $message.'
										<button type="button" class="btn btn-'.($page == $top_page ? 'secondary' : 'success').'" onClick="location.href=\'../YesterPeakPlayersTop/?page='.$top_page.'\'">맨 뒤</button>
									</div>
								</center>
							</li>
							';
