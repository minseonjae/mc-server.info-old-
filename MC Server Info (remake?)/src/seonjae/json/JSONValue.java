...
public class JSONValue {
	...
	public static void toString(Object value, Writer out, int count) {
		...
		else if (value instanceof String[]) JSONArray.toString((String[]) value, out, count);
		else if (value instanceof Double[]) JSONArray.toString((Double[]) value, out, count);
		else if (value instanceof Float[]) JSONArray.toString((Float[]) value, out, count);
		else if (value instanceof Number[]) JSONArray.toString((Number[]) value, out, count);
		else if (value instanceof Boolean[]) JSONArray.toString((Boolean[]) value, out, count);
	}
