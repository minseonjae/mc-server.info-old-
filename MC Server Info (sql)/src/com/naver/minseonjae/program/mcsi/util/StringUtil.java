package com.naver.minseonjae.program.mcsi.util;
...
public class StringUtil {
	...
	public String connectString(Object[] array, String connectChar) {
		return connectString(array, 0, connectChar);
	}
	public String connectString(Object[] array, int start, String connectChar) {
		StringBuilder sb = new StringBuilder();
		for (int i = start; i < array.length; i++) 
			if (array[i] != null)
				sb.append((sb.length() < 1 ? "" : connectChar) + array[i]);
